...
public class EncapsulationConcept {
	...
	// 1. make it private variables so that no one can access from outside the
	// class and
	// Encapsulation is also called Data hiding method, it is part of OOP
	// concepts.
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Employee Date of Birth is: " + emp.getEmployeeDOB());
		System.out.println("Employee Phone Number is: " + emp.getEmployeePhn());

	}

	// 2. get public getter and setter method: to set and get the values from
	// the fields.
